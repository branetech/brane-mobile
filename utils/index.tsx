...
export const accnt = (): Acc[] => [
  {
    ...
    content: [
      ...
      {
        icon: <TagUser size={20} color='#013D25' />,
        text: "Next of Kin details",
        routes: "update-kin-details",
      },
      {
        icon: <Verify size={20} color='#013D25' />,
  ...
  },
  {
    ...
    content: [
      {
        icon: <Lock size={20} color='#013D25' />,
        text: "Change password",
        routes: "change-password",
      },
      {
        icon: <PasswordCheck size={20} color='#013D25' />,
        text: "Reset transaction PIN",
        routes: "reset-transaction-pin",
      },
      {
        icon: <UserOctagon size={20} color='#013D25' />,
  ...
  },
  {
    ...
    content: [
      {
        icon: <Setting3 size={20} color='#013D25' />,
        text: "Preferences",
        routes: "preferences",
      },
      {
        icon: <MessageQuestion size={20} color='#013D25' />,
        text: "Help desk",
        routes: "help-desk",
      },
      {
        icon: <Message2 size={20} color='#013D25' />,
        text: "Live chat",
        routes: "support",
      },
      {
...
export type Currency = "NGN" | "USD" | "GBP" | "USDC";

export const CURRENCIES: { label: string; value: Currency; flag: string }[] = [
  { label: "Naira (NGN)", value: "NGN", flag: "🇳🇬" },
  { label: "Dollar (USD)", value: "USD", flag: "🇺🇸" },
  { label: "Euro (GBP)", value: "GBP", flag: "🇬🇧" },
  { label: "USDC", value: "USDC", flag: "🪙" },
];
...
export const ASSET_CATEGORIES = [
  {
    id: "stocks",
    label: "Stocks",
    desc: "Invest in Nigeria and International(US) stocks",
    bg: "#E8F5EF",
  },
  {
    id: "etf",
  ...
  },
  {
    id: "gold",
    label: "Gold",
    desc: "Invest in Nigeria and US stocksuctucu",
    bg: "#FDF6E3",
  },
  {
    id: "reits",
    label: "REITs",
    desc: "Invest in Real Estate. Invest in Real Estate",
    bg: "#EDE8F8",
  },
  {
    id: "index",
  ...
  },
  {
    id: "fixed",
    label: "Fixed Income",
    desc: "Invest in Nigeria and US stocks",
    bg: "#FEF0E6",
  },
];
...
export const FORUM_POSTS = [
  {
    ...
    desc: "For you to have a seamless experience we require some details.",
    cta: "Start Learning →",
    author: "Name of author",
    experience: "Expereinence/date or any other attribute",
    body: "Lorem ipsum dolor sit amet consectetur. Et vitae eget volutpat libero integer vel tristique nisi. Gravida potenti aliquet ut morbi tristique arcu egestas. Tempor cursus duis quis placerat metus congue phasellus sapien. Ultricies proin ut mattis morbi suspendisse nunc sollicitudin accumsan tortor. Dolor mattis mauris id nibh dui magna ultricies posuere fringilla. Eu cursus e\n\nsapien accumsan quam phasellus. Ut non odio eu congue at duis quis.\nMorbi libero amet vel semper. A molestie et a commodo quam ut. Tellus dictum nulla egestas tellus ipsum id. Ultricies sed ut faucibus ultrices volutpat ac. Pulvinar ut turpis leo dui quam. Arcu id urna sed pulvinar a dui elit ut lectus. Morbi tortor interdum sem dui tellus eget sit. Sem eget pellentesque cum vitae tristique velit. Varius aliquam tincidunt eu morbi senectus.",
  },
  {
    id: "2",
    title: "How To Invest In Gold",
    desc: "Learn about gold investment opportunities available to you.",
    cta: "Start Learning →",
    author: "Gold Expert",
    experience: "Expert advisor / 5 years experience",
    body: "Gold investment is one of the most reliable ways to build wealth. This comprehensive guide covers everything from understanding gold pricing to diversifying your portfolio with gold assets.\n\nWhy invest in gold? Gold has historically been a safe haven asset that maintains its value over time. Unlike currencies that can be devalued by inflation, gold retains purchasing power across generations.\n\nTypes of gold investments include physical gold (bars, coins), gold ETFs, gold stocks, and gold futures. Each has its own advantages and considerations based on your investment goals and risk tolerance.",
  },
];
